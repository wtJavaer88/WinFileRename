...
public class WinFileNameIndex extends AbstractWinFileRen {
	 ...
	 * @return
	 */
	public WinFileNameIndex openIndexAlign() {
		this.renParameters.setIndexAlign(true);
		return this;
	}
	...
	public String renOneFile(String fileName, String extendName) {
		...
		if (isIndexAlign())
			indexStr = BasicStringUtil.fillLeftStringNotruncate(indexStr, (this.fileCounts + "").length(), "0");
		String result = rule.replace("<#>", indexStr).replace("<SELF>", fileName) + extendName;
		return result;
	}
}
